...
public class ReservaLogicTest {
    ...
    public void createReservaDuplicadas() throws BusinessLogicException
    {
        ...
        VehiculoEntity car = new VehiculoEntity();
        car.setMarca("BMW");
        car.setModelo("2020");
        car.setPlaca("AXW390");
        car.setCapacidad(4);
        car.setRegistro(new RegistroEntity());
        newEntity.setVehiculo(car);
        newEntity2.setVehiculo(car);
        
        ReservaPersistence pe = reservaLogic.getRservaPersitence();
        ReservaEntity result = reservaLogic.createReserva(newEntity);
        pe.create(newEntity);
