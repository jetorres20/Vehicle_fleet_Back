...
import co.edu.uniandes.csw.automotor.resources.EstudianteResource;
...
public class EstudianteIT {
    ...
    private static final String COLLECTION = "PruebasEstudiante.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_automotor-api.war")
                ...
                .addPackage(EstudianteResource.class.getPackage())
