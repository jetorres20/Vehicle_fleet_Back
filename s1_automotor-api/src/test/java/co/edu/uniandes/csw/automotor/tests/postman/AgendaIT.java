...
public class AgendaIT {
    private static final String COLLECTION = "PruebasAgenda.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_automotor-api.war")
                ...
                .addPackage(AgendaResource.class.getPackage()) 
                .addPackage(AgendaDTO.class.getPackage()) 
