...
import co.edu.uniandes.csw.automotor.resources.RegistroResource;
...
public class RegistroIT {
    ...
    private static final String COLLECTION = "PruebasRegistro.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_automotor-api.war")
                ...
                .addPackage(RegistroResource.class.getPackage())
                .addPackage(RegistroDTO.class.getPackage())
