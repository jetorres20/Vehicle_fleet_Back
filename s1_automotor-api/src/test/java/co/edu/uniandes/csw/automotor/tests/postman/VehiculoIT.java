...
import co.edu.uniandes.csw.automotor.resources.VehiculoResource;
...
public class VehiculoIT {
    ...
    private static final String COLLECTION = "PruebasVehiculo.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_automotor-api.war")
                ...
                .addPackage(VehiculoDTO.class.getPackage())
