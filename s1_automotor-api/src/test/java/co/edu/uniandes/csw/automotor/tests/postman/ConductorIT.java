...
import co.edu.uniandes.csw.automotor.resources.ConductorResource;
...
public class ConductorIT {
    private static final String COLLECTION = "PruebasConductor.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_automotor-api.war")
                ...
                .addPackage(ConductorResource.class.getPackage()) 
                .addPackage(ConductorDTO.class.getPackage()) 
