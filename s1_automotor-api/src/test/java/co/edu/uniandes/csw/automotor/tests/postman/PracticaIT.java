...
import co.edu.uniandes.csw.automotor.resources.PracticaResource;
import co.edu.uniandes.csw.automotor.resources.ProfesorResource;
...
public class PracticaIT {
     private static final String COLLECTION = "PruebasPractica.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_automotor-api.war")
                ...
                .addPackage(PracticaResource.class.getPackage()) 
                .addPackage(PracticaDTO.class.getPackage()) 
