...
public class UniversidadIT {
    
    private static final String COLLECTION = "UniversidadResourceTest.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_automotor-api.war")
                ...
                .addPackage(UniversidadResource.class.getPackage())
                .addPackage(UniversidadDTO.class.getPackage())
