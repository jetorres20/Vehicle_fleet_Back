...
public class ProfesorIT {
     private static final String COLLECTION = "PruebasProfesor.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_automotor-api.war")
                ...
                .addPackage(ProfesorResource.class.getPackage()) 
                .addPackage(ProfesorDTO.class.getPackage()) 
